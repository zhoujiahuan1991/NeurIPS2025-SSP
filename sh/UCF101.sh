...
dataset_update_freq["Breakfast"]=16
...
do
    ...
    do
        ...
        output_dir="./output/$tuning_config/$dataset/output-ViM-$tuning_config-f$num_frames"
        log_dir="./logs/$tuning_config/$dataset/logs-ViM-$tuning_config-f$num_frames"
